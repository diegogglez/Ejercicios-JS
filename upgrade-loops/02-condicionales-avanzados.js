...
for (let i = 0; i < alumns.length; i++) {
  if (
      (alumns[i].T1 === true && (alumns[i].T2 === true || alumns[i].T3 === true)) ||
      (alumns[i].T2 === true && (alumns[i].T1 === true || alumns[i].T3 === true)) ||
      (alumns[i].T3 === true && (alumns[i].T1 === true || alumns[i].T2 === true))
      ) {
